  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6">
        <AICoach
          pageContext={{
            pageName: "Revenue Forecasting",
            description: "30/60/90-day revenue forecasts with confidence intervals",
            metrics: forecasts.length > 0 ? {
              forecast30d: forecasts.find(f => f.period === '30d')?.forecastedMRR,
              forecast60d: forecasts.find(f => f.period === '60d')?.forecastedMRR,
              forecast90d: forecasts.find(f => f.period === '90d')?.forecastedMRR,
            } : undefined,
          }}
        />
      </div>
